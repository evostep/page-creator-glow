    ...
    <div className="min-h-dvh bg-background font-sans text-foreground">
      <div className="mx-auto max-w-3xl px-6 py-12 md:py-16">
        ...
        <div className="mt-6 space-y-4 text-foreground/85 leading-relaxed">
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">5. Cu cine partajăm informațiile</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">6. Transferuri internaționale</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">7. Cât timp păstrăm datele</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">8. Cum protejăm informațiile</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">9. Drepturile tale</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">10. Conținutul creat de utilizatori</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">11. Cookie-uri și servicii terțe</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">12. Modificarea acestei politici</h2>
          ...
          <h2 className="mt-6 font-serif text-2xl font-bold tracking-tight">13. Contact</h2>
